...
ALTER TABLE `log_checking` MODIFY `time` bigint NOT NULL;
ALTER TABLE `log_identification` MODIFY `time` bigint NOT NULL;
ALTER TABLE `log_tracking` MODIFY `time` bigint NOT NULL;
