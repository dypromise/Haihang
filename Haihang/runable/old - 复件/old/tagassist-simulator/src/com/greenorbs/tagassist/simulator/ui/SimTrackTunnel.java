...
public class SimTrackTunnel extends Parent {
	
	private SimReaderServer _readerServer;

//	public SimTrackTunnel(Config.Direction dir) {
//		Group g = new Group();
//		AnchorPane ap = new AnchorPane();
//		g.getChildren().add(ap);
//
//		if (dir == Config.Direction.Vertical) {
//			ap.setPrefHeight(Config.CONVEYOR_ITSELF_WIDTH + 40);
//			ap.setPrefWidth(64.0);
//
//			ImageView top = new ImageView(new Image(getClass()
//					.getResourceAsStream("image/gate_vertical_top.png")));
//			ImageView bottom = new ImageView(new Image(getClass()
//					.getResourceAsStream("image/gate_vertical_bottom.png")));
//			ap.getChildren().addAll(top, bottom);
//			ap.setTopAnchor(top, 0.0);
//			ap.setBottomAnchor(bottom, 0.0);
//		} else {
//			ap.setPrefHeight(64.0);
//			ap.setPrefWidth(Config.CONVEYOR_ITSELF_WIDTH + 40);
//
//			ImageView left = new ImageView(new Image(getClass()
//					.getResourceAsStream("image/gate_horizontal_left.png")));
//			ImageView right = new ImageView(new Image(getClass()
//					.getResourceAsStream("image/gate_horizontal_right.png")));
