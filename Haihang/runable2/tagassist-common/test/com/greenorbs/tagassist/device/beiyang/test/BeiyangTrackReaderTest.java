...
import com.greenorbs.tagassist.device.beiyang.BeiyangTrackReader2;
import com.greenorbs.tagassist.device.beiyang2.BeiyangInfraredRay;

public class BeiyangTrackReaderTest {
	...
	public void testBeiyangTrackReader() throws HardwareException, InterruptedException {
		...
		BeiyangTrackReader2 infraredray = (BeiyangTrackReader2) ctx
				.getBean("trackReader2");
		infraredray.startup();
		Thread.sleep(10000);
