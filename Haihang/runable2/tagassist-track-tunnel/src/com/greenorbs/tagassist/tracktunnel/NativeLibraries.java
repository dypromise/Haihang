...
/**
 * Copyright (C) 2013 Kaihuaxinye (www.huasys.com)
 *
 * All Rights Reserved.
 *
 * Author: Tianci Liu
 *
 * Time: Created on 2013-8-19
 **/
...
import com.greenorbs.tagassist.device.beiyang.BeiyangReaderDriver;
...
public class NativeLibraries
{
    ...
    public static void main(String[] args){
    	BeiyangReaderDriver driver = (BeiyangReaderDriver) Native.loadLibrary(
				"BY_RFIDRD600", BeiyangReaderDriver.class);
    	try {
			NativeLibraries libraries = new NativeLibraries();
			System.out.println(libraries.getLoadedLibraries());
